...
@Suppress("PropertyName")
val mapping_channel = property("mapping_channel")

@Suppress("PropertyName")
val mapping_version = property("mapping_version")
...
@Suppress("PropertyName")
val forge_version = property("forge_version")

@Suppress("PropertyName")
val forge_version_range = property("forge_version_range")
